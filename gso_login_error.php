...
$errorOccurred = isset($_SESSION['login_error']) && $_SESSION['login_error'];
    ...
    <div class="frame-parent">
      ...
      <form id="loginForm" action="gso_login_confirm.php" method="POST">
        ...
        <div class="rectangle-container">
          ...
          <input type="text" class="input-field <?php if($errorOccurred) echo 'error'; ?>" id="username" name="username" placeholder="Enter your email" required>
        </div>
        <div class="frame-div">
          <div class="frame-inner"></div>
          <b class="student-id">Password</b>
          <input type="password" class="input-field <?php if($errorOccurred) echo 'error'; ?>" id="password" name="password" placeholder="Enter your password" required>
        </div>
