document.addEventListener("DOMContentLoaded", function() {
    const ticketsElement = document.querySelector(".dashboard16");
...
document.addEventListener("DOMContentLoaded", function() {
    const ticketsElement = document.querySelector(".notifications15");
    ticketsElement.addEventListener("click", function() {
...
document.addEventListener("DOMContentLoaded", function() {
    const ticketsElement = document.querySelector(".messages9");
    ticketsElement.addEventListener("click", function() {
...
document.addEventListener("DOMContentLoaded", function() {
    const ticketsElement = document.querySelector(".files16");
    ticketsElement.addEventListener("click", function() {
