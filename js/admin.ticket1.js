document.addEventListener("DOMContentLoaded", function() {
    const ticketsElement = document.querySelector(".dashboard19");
...
document.addEventListener("DOMContentLoaded", function() {
    const ticketsElement = document.querySelector(".notifications18");
    ticketsElement.addEventListener("click", function() {
...
document.addEventListener("DOMContentLoaded", function() {
    const ticketsElement = document.querySelector(".messages12");
    ticketsElement.addEventListener("click", function() {
...
document.addEventListener("DOMContentLoaded", function() {
    const ticketsElement = document.querySelector(".services19");
    ticketsElement.addEventListener("click", function() {
...
document.addEventListener("DOMContentLoaded", function() {
    const ticketsElement = document.querySelector(".files19");
    ticketsElement.addEventListener("click", function() {
...
document.addEventListener("DOMContentLoaded", function() {
    const ticketsElement = document.querySelector(".settings20");
    ticketsElement.addEventListener("click", function() {
